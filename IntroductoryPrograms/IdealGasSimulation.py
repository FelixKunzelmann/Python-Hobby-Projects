...
class GasVisualizer:
    ...
    def __init__(self, simulation: IdealGasSimulation, window_width: int = 1000,
        ...
        self.scale_y = (window_height - 150) / simulation.box.height
        self.offset_x = 50
        self.offset_y = 50
    ...
    def draw_statistics(self):
        ...
        self.screen.blit(title, (left_margin, y_offset))
        ...
        for text in stat_texts:
            ...
            self.screen.blit(label, (left_margin, y_offset))
            y_offset += 25
        ...
        self.screen.blit(mode, (self.window_width - 120, y_offset - 100))
